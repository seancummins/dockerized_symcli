...
* Download [SE 8.0.2](https://download.emc.com/downloads/DL58417_Solutions-Enabler-8.0.2-for-Linux-x64.tar.gz) and move it into the "dockerized_symcli/se8" directory.
